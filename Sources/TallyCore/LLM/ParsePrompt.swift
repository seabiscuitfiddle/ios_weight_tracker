...
public enum ParsePrompt {
    ...
    public static let system = """
        ...
        coffee" is three items; a composed dish like "chicken burrito bowl" is one. Every item \
        is corrected on its own afterwards, so split the description across the items rather \
        than repeating it: see `sourceText`.
        ...
        `sourceText`: the user's own words for this item and no others, copied across verbatim. \
        "Two eggs, sourdough toast with butter and a black coffee" gives "Two eggs", "sourdough \
        toast with butter" and "a black coffee" — a fragment each, never the whole sentence \
        three times. Include the words that qualify this item, such as a quantity or "no \
        dressing", and leave out linking words that belong to no item. When one item covers the \
        entire description, that description is its `sourceText`. Empty when the item came from \
        a photo and the user's words say nothing about it.
            ...
            "items": {
              ...
              "items": {
                ...
                "properties": {
                  ...
                  "sourceText": {
                    "type": "string",
                    "description": "The user's own words for this item alone, verbatim. Empty when there are none."
                  },
                  "calories": {
                    "type": "integer",
                ...
                "required": [
                  "kind", "label", "sourceText", "calories", "proteinGrams", "fiberGrams",
